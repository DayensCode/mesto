...
function createCard(dataCard) {
	const card = new Card(dataCard, '#element-template', popupViewElement, popupPhoto, popupDescription, (name,link) => {
		modalView.openPopup();
		popupPhoto.src = link;
		popupPhoto.alt = name;
...
initialCards: initialCards,
	...
	const modalView = new PopupWithImage('.popup_view', popupPhoto, popupDescription);
